...
import 'package:glamify_app_me/controllers/auth_controller.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  _signUpUser() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      return SnackBar(
        backgroundColor: const Color.fromARGB(255, 30, 14, 0),
        content: Text(
        ...
        child: RichText(
          ...
          text: TextSpan(
            ...
            children: [
              TextSpan(
                  text: signIn.tr,
                  style: color7AFF18w50018.copyWith(
                      decoration: TextDecoration.underline,
                      color: Color.fromARGB(255, 52, 23, 11)),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Let's start the best product shopping with me",
                      style: TextStyle(
                        color: Color.fromARGB(255, 68, 46, 38),
                        fontSize: 13,
                        letterSpacing: 2,
