// ignore_for_file: prefer_final_fields, unused_field, unused_local_variable, prefer_const_constructors_in_immutables, avoid_print, curly_braces_in_flow_control_structures, prefer_const_constructors, sort_child_properties_last, prefer_interpolation_to_compose_strings, sized_box_for_whitespace
          ...
          children: [
            Container(
              decoration: BoxDecoration(
                color: Color.fromARGB(255, 255, 225, 215),
                border: Border.all(
                  width: 8,
                ),
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Column(
                        ...
                        children: [
                          Text('Name: ' + myName!,
                                  style:
                                      TextStyle(fontSize: 20, color: appbarclr))
                              .paddingOnly(top: 30),
                          Text(
                            'Em ail: ' + myEmail!,
                            style: TextStyle(fontSize: 15, color: appbarclr),
                          ).paddingOnly(top: 20),
                          Text(
