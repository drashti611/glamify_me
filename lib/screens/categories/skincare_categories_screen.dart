...
class SkinCategoriesScreen extends StatefulWidget {
  const SkinCategoriesScreen({super.key});

  @override
  State<SkinCategoriesScreen> createState() => _SkinCategoriesScreenState();
}

class _SkinCategoriesScreenState extends State<SkinCategoriesScreen> {
  String? userName;
  String? userEmail;
