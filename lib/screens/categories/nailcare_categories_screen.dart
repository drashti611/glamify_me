...
class NailcareCategoriesScreen extends StatefulWidget {
  const NailcareCategoriesScreen({super.key});

  @override
  State<NailcareCategoriesScreen> createState() =>
      _NailcareCategoriesScreenState();
}

class _NailcareCategoriesScreenState extends State<NailcareCategoriesScreen> {
