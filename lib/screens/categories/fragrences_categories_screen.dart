...
class FragrencesCategoriesScreen extends StatefulWidget {
  const FragrencesCategoriesScreen({super.key});

  @override
  State<FragrencesCategoriesScreen> createState() =>
      _FragrencesCategoriesScreenState();
}

class _FragrencesCategoriesScreenState
    extends State<FragrencesCategoriesScreen> {
